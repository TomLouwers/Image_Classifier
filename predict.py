...
training_loader, testing_loader, validation_loader = ImageClass.load_data()

ImageClass.load_checkpoint(path)

with open('cat_to_name.json', 'r') as json_file:
    cat_to_name = json.load(json_file)

probabilities = ImageClass.predict(path_image, model, number_of_outputs, power)
